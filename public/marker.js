...
var imageE = "https://cdn.icon-icons.com/icons2/1102/PNG/512/1485969928-17-location_78896.png"; // E_마커 이미지
var imageA = "https://cdn.icon-icons.com/icons2/1559/PNG/512/3440906-direction-location-map-marker-navigation-pin_107531.png"; // A_마커 이미지
...
D_positions.forEach(function(pos) {  // D동 마커 관리
...
B_positions.forEach(function(pos) {  // B동 마커 관리
// 마커 생성
...
E_positions.forEach(function(pos) {  // E동 마커 관리
  // 마커 생성
...
var A_positions = [
  {
      ...
      testing: "할로",
      content: "건물에 관한 설명",
      image: "http://ocean.cu.ac.kr/files/W_CONTENTS/920/thumb_20160919143352.jpg"
  },
  {
      title: '교양관 A2', 
...
A_positions.forEach(function(pos) {  // A동 마커 관리
  // 마커 생성
  var imageSize = new kakao.maps.Size(25, 25); // 마커 이미지 크기
...
C_positions.forEach(function(pos) {  // C동 마커 관리
  // 마커 생성
